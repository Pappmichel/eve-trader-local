...
full priced planner (`engine.plan_special_order`) so those stay button
actions, same as every other planner-backed view here. Combine is
preview-only: selected orders are pooled (shared type_ids summed) and never
modified.
"""
