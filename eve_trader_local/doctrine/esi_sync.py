...
Also deliberately left out of this port: GitHub issue #19's
doctrine_contract_history (a permanent "who bought what and when" log,
additive on top of what's ported here - see storage.py's schema comment).
"""
